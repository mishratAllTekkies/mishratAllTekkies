...
import com.htf.zbCard.ui.auth.completeKyc.adapter.ImageAdapter
import com.htf.zbCard.ui.auth.completeKyc.adapter.ImageAdapterListener
...
class AppScanActivity : ScanActivity(), ImageAdapterListener {
    ...
    private fun saveImage(image: File) {
        ...
        val to = File(Environment.getExternalStorageDirectory().absolutePath + "/" + DIRECTORY_DCIM + "/download${dateFormatted}.jpg")
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            ...
            contentValues.put(MediaStore.MediaColumns.DISPLAY_NAME, "download${dateFormatted}.jpg")
